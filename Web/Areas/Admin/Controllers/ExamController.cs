...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class ExamController(IExamService examService) : BaseController
    {
        ...
        public IActionResult Grid_Data_Read([DataSourceRequest] DataSourceRequest request, string filterTitle)
        {
            //Paging and Sorting
            ...
            var result = new DataSourceResult()
                         {
                             Data = examService.GetAllFiltered(filterTitle, null, currentPage, pageSize, out int totalRecord),
