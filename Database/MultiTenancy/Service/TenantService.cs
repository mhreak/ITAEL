...
using InfraStructure.MultiTenancy.Service.Interface;

namespace InfraStructure.MultiTenancy.Service
{
    public class TenantService : ITenantService
    {
        ...
        {
            _currentTenant.ConnectionString = _tenantSettings.DefaultConfig.ConnectionString;
        }
        ...
        {
            return _tenantSettings.DefaultConfig?.DBProvider;
        }
